...
for i=1:n
  ...
  switch l.type
    ...
    case 'hebbian3'
      if testMode
        [res(i+1).x, res(i).v] = vl_nnhebbian3(res(i).x, l.v, l.indices, ...
                    'lambda', l.lambda, 'eta', l.eta, 'beta', l.beta, 'connectivity', ...
                    l.connectivity, 'update', l.update, ...
                    'mode', 'test', 'pass', 'forward') ;
      else
        [res(i+1).x, res(i).v] = vl_nnhebbian3(res(i).x, l.v, l.indices, ...
                    'lambda', l.lambda, 'eta', l.eta, 'beta', l.beta, 'connectivity', ...
...
if doder
  ...
  for i=n:-1:backPropLim
    ...
    switch l.type
      ...
      case 'hebbian3'
        if testMode
          [res(i).dzdx, res(i).v] = vl_nnhebbian3(res(i).x, l.v, l.indices, ...
                'lambda', l.lambda, 'eta', l.eta, 'beta', l.beta, 'connectivity', ...
                l.connectivity, 'update', l.update, 'mode', ...
                'test', 'pass', 'backward', 'dzdx', res(i+1).dzdx) ;
        else
          [res(i).dzdx, res(i).v] = vl_nnhebbian3(res(i).x, l.v, l.indices, ...
                'lambda', l.lambda, 'eta', l.eta, 'beta', l.beta, 'connectivity', ...
                l.connectivity, 'update', l.update, 'mode', ...
                'train', 'pass', 'backward', 'dzdx', res(i+1).dzdx) ;
        end
